        ...
        <div className={styles.content}>
          <div className={styles.textContent}>
            ...
            <p>
              ...
              JavaScript and its ecosystem. My journey began with web
              development, but I quickly fell in love with React Native&apos;s
              ability to create native mobile experiences with the web
              technologies I already knew.
            </p>
            <p>
              Over the years, I&apos;ve specialized in building scalable
              applications that provide exceptional user experiences. From
              mobile apps that serve thousands of users to backend systems that
              handle complex business logic, I enjoy every aspect of the
              development process.
            </p>
            <p>
              As a generalist JavaScript developer with a passion for back-end
              and software architecture, I&apos;ve been working with
              React/React-Native/NodeJS since 2015. I&apos;m constantly learning
              and exploring new technologies like Go, Elixir, Docker,
